...
module.exports = {
    'must_agree_tos': '서비스 및 이용 약관 동의를 확인 해주세요',
    ...
    'wallet_password_too_short': '지갑 주소 암호는 최소한 6자 이상이어야 합니다',
    'max_address_count_reached': (count) => `계정은 ${count}개의 주소만 개설이 가능합니다`,
    'need_both_view_and_spend': '열람과 전송 Secret Key가 필요합니다',
    'incorrect_view': '열람 키가 정확하지 않습니다',
    'incorrect_spend': '전송 키가 정확하지 않습니다',
    'tx_too_big': '트랜젝션 크기가 너무 큽니다. 보내실 수량이나 Mixin Count를 줄여주세요',
    'fee_too_low': (minimum) => `트랜젝션 수수료가 최저 수수료보다 작습니다: ${minimum}`,
    ...
    'wrong_mixing_level': 'Mixin Level 오류',
    'wrong_tx_fee': '트랜젝션 수수료 오류',
    'spending_address_not_authorized': '승인된 주소가 발신자 주소와 일치하지 않습니다',
    'mixin_too_big': (mixin) => `Mixin이 너무 큽니다 ${mixin}`,
    ...
    'tmp_password_email_body': ({ email, newPassword}) => `
        ...
        <p>감사합니다.<br>BBS.money <br>${config.www.baseUrl}</p>`,
    'too_many_unverified_tx': (left) => `트랜젝션 검증 중단. 이 주소에 ${left}의 미검증된 트랜젝션이 남았습니다. 다시 시도하여 주세요.`,
    'fail_to_send': '트랜젝션 전송 불가. 수량을 줄여서 다시 시도하여 주세요',
